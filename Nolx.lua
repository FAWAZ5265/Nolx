...
SUDO = SUDO
sudo_users = {SUDO,1619524486,2067510449}   
print([[
> CH › @@Nolx_Channel
~> DEVELOPER › @WtttW
]])
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FAWAZ5265/Files_Nolx/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevNolxW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevNolxW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevNolxW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevNolxW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevNolxW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevNolxW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevNolxW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "Nolx_Channel")
...
Nolx_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Nolx_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Nolx_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Nolx_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@WtttW")  
...
--------------------------------------------------------------------------------------------------------------
function SourceNolx(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."Nolx1:List:Filter"..sl)
...
if not DevNolxW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevNolxW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Nolx_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✹' and DevNolxW(msg) then  
...
if text == 'تعطيل التواصل ✹' and DevNolxW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✹' and DevNolxW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✹' and DevNolxW(msg) then  
...
if text == 'ضع كليشه ستارت ✹' and DevNolxW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✹︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✹' and DevNolxW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✹︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✹' and DevNolxW(msg) then 
...
if text == 'تحديث السورس ✹' and DevNolxW(msg) then 
os.execute('rm -rf Nolx.lua')
os.execute('wget https://raw.githubusercontent.com/FAWAZ5265/Nolx/main/Nolx.lua')
send(msg.chat_id_, msg.id_,' *✹︙تم تحديث السورس* \n*✹︙لديك اخر اصدار لسورس فلوركس*\n*✹︙الاصدار » { 2.8v}*')
dofile('Nolx.lua')  
end
if text == 'الاصدار ✹' and DevNolxW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✹︙اصدار سورس فلوركس* \n*✹︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✹' and DevNolxW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✹︙[تحديثات البوت](t.me/NOLX_chat) \n✹︙[قناه السورس](t.me/Nolx_Channel)')
end
if text == "ضع اسم للبوت ✹" and DevNolxW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✹︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✹' and DevNolxW(msg) then 
...
if text == 'المشتركين ✹' and DevNolxW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✹︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'القروبات ✹' and DevNolxW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✹︙القروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✹") and DevNolxW(msg) then
...
if text == ("قائمه العام ✹") and DevNolxW(msg) then
...
if text == ("قائمه الكتم العام ✹") and DevNolxW(msg) then
...
if text=="اذاعه خاص ✹" and msg.reply_to_message_id_ == 0 and DevNolxW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✹︙ارسل الان اذاعتك؟* \n*✹︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✹" and msg.reply_to_message_id_ == 0 and DevNolxW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✹︙ارسل الان اذاعتك؟* \n*✹︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✹" and msg.reply_to_message_id_ == 0 and DevNolxW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✹︙ارسل الان اذاعتك؟* \n*✹︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✹" and msg.reply_to_message_id_ == 0  and DevNolxW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✹︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✹" and msg.reply_to_message_id_ == 0  and DevNolxW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✹︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✹' and DevNolxW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✹" and DevNolxW(msg) then
...
if text == "تنظيف القروبات ✹" and DevNolxW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✹︙عدد القروبات الان » { '..#group..' }'..Nolxk..''..Nolx..'*\n*✹︙الان عدد القروبات الحقيقي » { '..sendok..' } قروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevNolxW(msg) then
...
usertext = '*\n ✹︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'Nolx_Channel')..')'
status  = '\n *✹︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevNolxW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✹︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Nolx_Channel')..')'
status  = '\n*✹︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevNolxW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevNolxW(msg) then
...
local Nolx1_Msg = database:get(bot_id.."Nolx1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Nolx1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✹︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Nolx_Channel')..') \n ✹︙'..Nolx1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Nolx_Msg and not Special(msg) then  
local Nolx_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Nolx_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✹︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✹︙["..Nolx_Msg.."] \n")
else
send(msg.chat_id_,0," *✹︙العضو :* {["..data.first_name_.."](T.ME/Nolx_Channel)}\n✹︙["..Nolx_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✹︙عذرا ↫* {["..data.first_name_.."](T.ME/Nolx_Channel)}\n*✹︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevNolxW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevNolxW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevNolxW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✹︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevNolxW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✹︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✹" and DevNolxW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✹︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✹$") and DevNolxW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✹︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✹" and DevNolxW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✹" and DevNolxW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✹︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✹" and DevNolxW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."Nolx:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Nolx:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Nolx = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Nolx then 
names_Nolx = database:smembers(bot_id.."Nolx:blocname"..msg.chat_id_) or ""
if names_Nolx and names_Nolx[1] then 
for i=1,#names_Nolx do 
if name_Nolx:match("(.*)("..names_Nolx[i]..")(.*)") then 
...
database:set(bot_id.."Nolx:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Nolx:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Nolx:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Nolx:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Nolx:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Nolxa_new(Nolx1,Nolx2)
if Nolx2 and Nolx2.first_name_ then 
if Nolx2.first_name_:match("(.*)"..database:get(bot_id.."Nolx:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Nolx:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Nolx_nnn = database:get(bot_id.."Nolx:nump"..msg.chat_id_) or 5
local Nolx_nnn2 = database:get(bot_id.."Nolx:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Nolx_nnn2) == tonumber(Nolx_nnn) or tonumber(Nolx_nnn2) > tonumber(Nolx_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Nolx:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✹︙عزيزي >>["..Nolx2.username_.."](https://t.me/"..(Nolx2.username_ or "Nolx_Channel")..")\n✹︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Nolx:teh"..msg.chat_id_).."} بجانب اسمك\n✹︙عدد المحاولات المتبقيه {"..(tonumber(Nolx_nnn) - tonumber(Nolx_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Nolxa_new)
end
end
...
local NolxChengName = database:get(bot_id.."Nolx:Cheng:Name"..data.id_)
if not data.first_name_ then 
if NolxChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..NolxChengName..']')
database:del(bot_id.."Nolx:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if NolxChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Nolx:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local NolxChengUserName = database:get(bot_id.."Nolx:Cheng:UserName"..data.id_)
if not data.username_ then 
if NolxChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..NolxChengUserName..']')
database:del(bot_id.."Nolx:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if NolxChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Nolx:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local NolxChengPhoto = database:get(bot_id.."Nolx:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if NolxChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Nolx:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if NolxChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Nolx:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ɴᴏʟx\n\n[✹  ɴᴏʟx ᴄʜᴀɴɴᴇʟ](http://t.me/Nolx_Channel)\n\n[✹  ᴄʜᴀᴛ sᴏᴜʀᴄᴇ](http://t.me/NOLX_chat)\n\n[✹  ɴᴏʟx ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/WtttW)\n\n[✹  ʙᴏᴛ ɴᴏʟx](http://t.me/M90XBOT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹ sᴏᴜʀᴄʀ ɴᴏʟx',url="t.me/NOLX_chat/123"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Nolx_Channel&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevNolxW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*✹︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Nolx_Channel')..') \n*✹︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✹︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Nolx_Channel')..') \n*✹︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevNolxW(msg) then
dofile('Nolx.lua')  
send(msg.chat_id_, msg.id_, ' *✹︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevNolxW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevNolxW(msg) then  
function start_function(extra, result, success)
if NolxSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevNolxW(msg) then  
...
if NolxSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✹︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevNolxW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if NolxSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✹︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevNolxW(msg) then  
function start_function(extra, result, success)
if NolxSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✹︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevNolxW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevNolxW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if NolxSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✹︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevNolxW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevNolxW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevNolxW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevNolxW(msg) then
...
if text == 'الملفات' and DevNolxW(msg) then
...
if DevNolxW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/FAWAZ5265/Files_Nolx/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✹︙اهلا بك في متجر ملفات فلوركس*\n*✹︙ملفات السورس ↓*\n*•━━━━━━ 𝗙𝗫 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝗙𝗫 ━━━━━━━•*\n *✹︙علامة تعني { ✓ } ملف مفعل*\n *✹︙علامة تعني { ✘ } ملف معطل*\n *✹︙قناة سورس فلوركس ↓*\n".." *✹︙*[اضغط هنا لدخول](t.me/Nolx_Channel) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevNolxW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/FAWAZ5265/Files_Nolx/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevNolxW(msg) then
...
if text == "مسح الملفات" and DevNolxW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✹︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevNolxW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevNolxW(msg) then  
function start_function(extra, result, success)
...
function Function_Nolx(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Nolx, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Nolx, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✹︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'Nolx_Channel')..')'
status  = '\n*✹︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✹︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Nolx_Channel')..')'
status  = '\n*✹︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✹︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✹︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Nolx_Channel')..')'
...
database:set(bot_id.."Nolx1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Nolx1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✹︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Nolx1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Nolx1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Nolx1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Nolx1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✹︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Nolx1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Nolx1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Nolx1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Nolx1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✹︙ارسل الكلمه الان*")  
database:set(bot_id.."Nolx1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Nolx1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Nolx1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Nolx1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Nolx1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Nolx1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Nolx1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Nolx1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Nolx1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevNolxW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✹︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevNolxW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✹︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'Nolx_Channel')..')'..'\n*✹︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevNolxW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevNolxW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Nolx_Msg[math.random(#Nolx_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevNolxW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,Nolx)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝗙𝗫 ━━━━━━━•*\n"
x = 0
local list = Nolx.members_
for k, v in pairs(list) do
x = x + 1
...
if NolxSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevNolxW(msg) then 
...
if text == ("ردود المطور") and DevNolxW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✹︙قائمة ردود المطور \n*•━━━━━━ 𝗙𝗫 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevNolxW(msg) then    
send(msg.chat_id_, msg.id_,' *✹︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevNolxW(msg) then    
...
if text == 'تفعيل المغادره' and DevNolxW(msg) then   
...
if text == 'تعطيل المغادره' and DevNolxW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✹︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'NOLX_chat')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Nolx_Channel')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Nolxdx(msg.chat_id_, msg.id_, ' *✹︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✹︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✹︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✹︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevNolxW(msg) then
...
{{text = '𝗡𝗼𝗹𝘅 𝗧𝗲𝗮𝗺 .', url="t.me/NOLX_chat"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ɴᴏʟx',url='http://t.me/NOLX_chat'}},
}
...
Nolx = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Nolx)
...
------------------------------------------------------------------------
local NolxAbot = database:get(bot_id.."Nolx1:Add:Filter:Rp2"..text..result.chat_id_)   
if NolxAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✹︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✹︙["..NolxAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Nolx1_Msg = database:get(bot_id.."Nolx1:Add:Filter:Rp2"..text..result.chat_id_)   
if Nolx1_Msg then
send(msg.chat_id_, msg.id_," ✹︙"..Nolx1_Msg)
